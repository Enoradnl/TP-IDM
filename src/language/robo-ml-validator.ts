...
import type { RoboMlAstType, RoboML } from './generated/ast.js';
...
export function registerValidationChecks(services: RoboMlServices) {
    ...
    const checks: ValidationChecks<RoboMlAstType> = {
        RoboML: validator.checkPersonStartsWithCapital
    };
...
export class RoboMlValidator {
    ...
    checkPersonStartsWithCapital(person: RoboML, accept: ValidationAcceptor): void {
        // if (person.name) {
